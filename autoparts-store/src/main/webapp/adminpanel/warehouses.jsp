...
<div id="wrapper">
    ...
    <%@include file='warehouses-add-modal.jsp'%>
    <%@include file='warehouses-edit-modal.jsp'%>
    <%@include file='warehouses-delete-modal.jsp'%>
                ...
                <div class="col-md-12">
                    <!-- Table -->
                        <div class="panel-heading">
                            ...
                            &middot;
                            <a href="/generateWarehousesXLS.action">Generate XLS</a>
                            &middot;
                            <a href="/generateWarehousesCSV.action">Generate CSV</a>
                        </div>
                                    ...
                                    <s:iterator value="warehousesList" var="warehouse">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                &middot;
                                                <a href="/generateWarehousePDF.action?id=<s:property value="id"/>">PDF</a>
...
<script>
    ...
    {
        $('.warehouses_add_modal').modal();
    }

    function showEditModal(instance)
    {
        $('#warehouses_edit_id').val($(instance).attr('id'));
        $('#warehouses_edit_name').val($(instance).attr('name'));
        $('#warehouses_edit_address').val($(instance).attr('address'));
        $('.warehouses_edit_modal').modal();
    }
